package org.example.assigment.yuki.Day20.model;

import org.example.assigment.yuki.Day20.annotation.NonNegativeField;
import org.example.assigment.yuki.Day20.annotation.NotNullField;
...
public class Product {
    ...
    public Product(Integer id, String name, double price, int quantity, Category productCategory) {
        this.id = id;
        this.name = name;
        this.price = price;
